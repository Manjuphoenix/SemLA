...
################################################################
        ...
        self.active_adapter = conv_adapter_name
    ...
    def active_peft_config(self):
        return self.peft_config[self.active_adapter]       # Error goes to line 984 in get_base_model()


    @property
    def active_peft_config_merge_tmp(self):
        import ipdb; ipdb.set_trace()
        return self.peft_config[self.active_adapter[0], self.active_adapter[1]]       # Error goes to line 984 in get_base_model()
