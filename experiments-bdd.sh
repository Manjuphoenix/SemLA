...
semla_config='./merge_confs/bdd/semla_config.yaml'
source_domains='./merge_confs/bdd/source_domains.yaml'
target_domains='./merge_confs/bdd/target_domains.yaml'
results_folder='./merge_confs/bdd/results/semla'
