...
semla_config='./merge_confs/asnow/semla_config.yaml'
source_domains='./merge_confs/asnow/source_domains.yaml'
target_domains='./merge_confs/asnow/target_domains.yaml'
results_folder='./merge_confs/asnow/results/semla'
