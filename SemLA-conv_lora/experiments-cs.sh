...
semla_config='./merge_confs/cs-normal/semla_config.yaml'
source_domains='./merge_confs/cs-normal/source_domains.yaml'
target_domains='./merge_confs/cs-normal/target_domains.yaml'
results_folder='./merge_confs/cs-normal/results/semla'
