...
class CATSeg(nn.Module):
    ...
    #     # This is to add the zero images in the batch.....
    #     # import ipdb; ipdb.set_trace()
    #     clip_zero1 = torch.zeros(clip_images.shape).cuda()

    #     clip_images = torch.cat((clip_images, clip_zero1[:3]), dim=0)
    #     # clip_images = clip_images.repeat(2, 1, 1, 1)
    #     # clip_images = clip_images[:8]
    #     ##############################################
    ...
    #     # This is to remove the zero images in the batch.....
    #     outputs = outputs[:-3]
