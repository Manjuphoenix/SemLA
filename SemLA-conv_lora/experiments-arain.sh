...
semla_config='./merge_confs/arain/semla_config.yaml'
source_domains='./merge_confs/arain/source_domains.yaml'
target_domains='./merge_confs/arain/target_domains.yaml'
results_folder='./merge_confs/arain/results/semla'
