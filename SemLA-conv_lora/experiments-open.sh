...
semla_config='./merge_confs/openearth/semla_config.yaml'
source_domains='./merge_confs/openearth/source_domains.yaml'
target_domains='./merge_confs/openearth/target_domains.yaml'
results_folder='./merge_confs/openearth/results/semla'
