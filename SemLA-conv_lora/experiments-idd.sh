...
semla_config='./merge_confs/idd/semla_config.yaml'
source_domains='./merge_confs/idd/source_domains.yaml'
target_domains='./merge_confs/idd/target_domains.yaml'
results_folder='./merge_confs/idd/results/semla'
