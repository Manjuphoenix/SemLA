...
semla_config='./merge_confs/mv/semla_config.yaml'
source_domains='./merge_confs/mv/source_domains.yaml'
target_domains='./merge_confs/mv/target_domains.yaml'
results_folder='./merge_confs/mv/results/semla'
