...
semla_config='./merge_confs/anight/semla_config.yaml'
source_domains='./merge_confs/anight/source_domains.yaml'
target_domains='./merge_confs/anight/target_domains.yaml'
results_folder='./merge_confs/anight/results/semla'
