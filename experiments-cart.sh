...
semla_config='./merge_confs/cart/semla_config.yaml'
source_domains='./merge_confs/cart/source_domains.yaml'
target_domains='./merge_confs/cart/target_domains.yaml'
results_folder='./merge_confs/cart/results/semla'
